  ...
  return (
    <div className="flex flex-col min-h-dvh bg-gradient-to-b from-white to-gray-50 dark:from-zinc-900 dark:to-black text-zinc-900 dark:text-white font-sans">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-0 w-full overflow-hidden">
        <div
          id="hero"
          className="w-full py-16 md:py-24 space-y-6 relative px-4 sm:px-6 lg:px-8"
        >
          {/* Decorative blurred circle */}
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-red-300 dark:bg-red-700 rounded-full filter blur-3xl opacity-20 dark:opacity-10 z-(--zindex-bg)"></div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-center relative z-(--zindex-fg)">
            Welcome to{" "}
