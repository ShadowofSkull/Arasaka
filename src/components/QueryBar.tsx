...
export default function Query() {
  ...
  return (
    <div className="w-full flex flex-col h-[calc(100vh-5rem)] relative z-(--zindex-fg)">
      {/* Chat history container */}
      <div
        ref={chatContainerRef}
        className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-red-400 scrollbar-track-zinc-100 dark:scrollbar-thumb-red-600 dark:scrollbar-track-zinc-800"
      >
        {showWelcome ? (
          ...
          chatHistory.map((message) => (
            ...
            >
              ...
              {/* Products displayed below assistant messages */}
              {message.role === "assistant" &&
                !!message.products &&
      ...
      <div className="border-t border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md p-4 sticky bottom-0">
        <Form action={handleSubmit} className="flex gap-2">
          ...
          >
            {isLoading ? (
              ...
              >
                <path
                  d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1
                  0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"
                />
              </svg>
            )}
          </button>
